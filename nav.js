...
.logo-wrap img{width:36px;height:36px;border-radius:50%;object-fit:cover;border:1px solid rgba(212,160,23,0.3)}
...
footer p{font-family:'Cinzel',serif;font-size:11px;color:rgba(255,255,255,0.22);letter-spacing:.05em}
footer a{color:rgba(240,192,64,0.45);text-decoration:none;margin:0 10px}
</style>
</head>
<body>
...
<nav>
  ...
  <div class="nav-right">
    ...
    <a class="nav-link" href="mahabharata.html">Mahabharata</a>
    <div id="navAuth"></div>
    <a class="btn-upgrade" href="premium.html">👑 Go Premium</a>
  </div>
</nav>
